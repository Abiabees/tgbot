...
class Development(Config):
    OWNER_ID =1977190927# my telegram ID
    OWNER_USERNAME = "@ABI_ABEES  # my telegram username
    API_KEY = "5598931861:AAFzUuobrH-l279jxqi0N7h6ngOrZJcIQ2c"  # my api key, as provided by the botfather
...
The following env variables are supported:
 ...
 - `TOKEN`: 5598931861:AAFzUuobrH-l279jxqi0N7h6ngOrZJcIQ2c
 - `OWNER_ID`: 1977190927
 - `OWNER_USERNAME`: @ABI_ABEES
